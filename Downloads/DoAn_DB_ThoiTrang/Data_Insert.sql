...
-- =======================================================
-- 2. TÀI KHOẢN & NHÂN SỰ CHUẨN (MÃ TỪ NV001 - NV012)
-- =======================================================
-- Tài khoản Nhân sự
...
-- Mã NV001-NV004: Quản lý
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV001', N'Nguyễn Trọng An', TO_DATE('1995-02-10', 'YYYY-MM-DD'), 'Nam', '0911000001', N'Q1, TP.HCM', N'Quản lý', SYSDATE - 365, 1, 'ql_an');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV002', N'Trần Thái Bình', TO_DATE('1996-04-15', 'YYYY-MM-DD'), 'Nam', '0911000002', N'Q3, TP.HCM', N'Quản lý', SYSDATE - 300, 1, 'ql_binh');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV003', N'Lê Việt Cường', TO_DATE('1994-08-20', 'YYYY-MM-DD'), 'Nam', '0911000003', N'Q5, TP.HCM', N'Quản lý', SYSDATE - 400, 1, 'ql_cuong');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV004', N'Phạm Tiến Dũng', TO_DATE('1997-11-05', 'YYYY-MM-DD'), 'Nam', '0911000004', N'Q7, TP.HCM', N'Quản lý', SYSDATE - 200, 1, 'ql_dung');

-- Mã NV005-NV008: Nhân viên Kho
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV005', N'Hoàng Thu Hà', TO_DATE('2000-01-20', 'YYYY-MM-DD'), N'Nữ', '0922000001', N'Thủ Đức', N'Nhân viên kho', SYSDATE - 150, 1, 'nvk_ha');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV006', N'Vũ Huy Hoàng', TO_DATE('1999-05-12', 'YYYY-MM-DD'), 'Nam', '0922000002', N'Bình Thạnh', N'Nhân viên kho', SYSDATE - 100, 1, 'nvk_hoang');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV007', N'Đặng Anh Khoa', TO_DATE('2001-09-08', 'YYYY-MM-DD'), 'Nam', '0922000003', N'Gò Vấp', N'Nhân viên kho', SYSDATE - 80, 1, 'nvk_khoa');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV008', N'Bùi Tùng Lâm', TO_DATE('1998-12-25', 'YYYY-MM-DD'), 'Nam', '0922000004', N'Tân Bình', N'Nhân viên kho', SYSDATE - 50, 1, 'nvk_lam');

-- Mã NV009-NV012: Nhân viên Bán hàng
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV009', N'Ngô Ngọc Mai', TO_DATE('2002-03-14', 'YYYY-MM-DD'), N'Nữ', '0933000001', N'Q10, TP.HCM', N'Nhân viên bán hàng', SYSDATE - 60, 1, 'nvb_mai');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV010', N'Đinh Bảo Ngọc', TO_DATE('2003-07-22', 'YYYY-MM-DD'), N'Nữ', '0933000002', N'Q1, TP.HCM', N'Nhân viên bán hàng', SYSDATE - 45, 1, 'nvb_ngoc');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV011', N'Lý Kiều Oanh', TO_DATE('2001-10-10', 'YYYY-MM-DD'), N'Nữ', '0933000003', N'Q3, TP.HCM', N'Nhân viên bán hàng', SYSDATE - 30, 1, 'nvb_oanh');
INSERT INTO NHANVIEN (MaNV, TenNV, NgaySinh, GioiTinh, SDT, DiaChi, ChucVu, NgayVaoLam, TrangThai, TenDangNhap) VALUES ('NV012', N'Hồ Lan Phương', TO_DATE('2000-02-28', 'YYYY-MM-DD'), N'Nữ', '0933000004', N'Q5, TP.HCM', N'Nhân viên bán hàng', SYSDATE - 15, 1, 'nvb_phuong');

-- =======================================================
-- 3. KHÁCH HÀNG (MÃ TỪ KH000001 - KH000006)
-- =======================================================
...
INSERT INTO KHACHHANG (MaKH, TenKH, SDT, DiemTichLuy, Email, TenDangNhap) VALUES ('KH000001', N'Khách Vãng Lai', '0000000000', 0, NULL, NULL);
INSERT INTO KHACHHANG (MaKH, TenKH, SDT, DiemTichLuy, Email, TenDangNhap) VALUES ('KH000002', N'Nguyễn Thị Thu', '0987654321', 150, 'thunguyen@gmail.com', 'kh_thu');
INSERT INTO KHACHHANG (MaKH, TenKH, SDT, DiemTichLuy, Email, TenDangNhap) VALUES ('KH000003', N'Trịnh Tú Quyên', '0944000001', 50, 'quyen@gmail.com', 'kh_quyen');
INSERT INTO KHACHHANG (MaKH, TenKH, SDT, DiemTichLuy, Email, TenDangNhap) VALUES ('KH000004', N'Cao Thanh Tâm', '0944000002', 120, 'tam@gmail.com', 'kh_tam');
INSERT INTO KHACHHANG (MaKH, TenKH, SDT, DiemTichLuy, Email, TenDangNhap) VALUES ('KH000005', N'Đào Tố Uyên', '0944000003', 0, 'uyen@gmail.com', 'kh_uyen');
INSERT INTO KHACHHANG (MaKH, TenKH, SDT, DiemTichLuy, Email, TenDangNhap) VALUES ('KH000006', N'Châu Tường Vy', '0944000004', 300, 'vy@gmail.com', 'kh_vy');

-- =======================================================
-- 4. NHÀ CUNG CẤP & KHUYẾN MÃI CHUẨN (MÃ TỪ 01)
-- =======================================================
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC001', N'Xưởng May Tân Bình', N'Q. Tân Bình, TP.HCM', '02838123456', 'tanbinh@xuongmay.com');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC002', N'Đại lý Phụ Kiện và Giày', N'Q. 10, TP.HCM', '02838654321', 'phukien@daily.com');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC003', N'Xưởng May Thủ Đức', N'Linh Trung, Thủ Đức, TP.HCM', '0901234003', 'thuduc@xuongmay.vn');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC004', N'Tổng Kho Vải Chợ Lớn', N'Q. 5, TP.HCM', '0901234004', 'vaicholon@tongkho.com');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC005', N'Công Ty Dệt May Vina', N'KCN Sóng Thần, Bình Dương', '0901234005', 'contact@vinadetmay.vn');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC006', N'Xưởng Gia Công Đồ Jean', N'Q. Tân Phú, TP.HCM', '0901234006', 'jeantanphu@xuong.com');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC007', N'Kho Phụ Kiện Quảng Châu', N'Q. Hà Đông, Hà Nội', '0901234007', 'phukienqc@kho.vn');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC008', N'Xưởng Giày Da VNXK', N'Củ Chi, TP.HCM', '0901234008', 'vnxkgiayda@xuonggiay.com');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC009', N'Đại Lý Sỉ Quần Tây Âu', N'Q. 10, TP.HCM', '0901234009', 'siquantay@daily.com');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC010', N'Xưởng May Áo Thun Cotton', N'Q. 12, TP.HCM', '0901234010', 'aothunq12@xuongmay.vn');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC011', N'Kho Túi Xách Xuất Khẩu', N'Biên Hòa, Đồng Nai', '0901234011', 'tuixachxk@kho.vn');
INSERT INTO NHACUNGCAP (MaNCC, TenNCC, DiaChi, SDT, Email) VALUES ('NCC012', N'Xưởng Mũ Nón Hạnh Phúc', N'Q. Bình Tân, TP.HCM', '0901234012', 'munonhp@xuong.com');
...
-- =======================================================
-- 5. PHIẾU NHẬP KHO (MÃ TỪ PN01 - PN06, KẾT NỐI NV005-NV008)
-- =======================================================
INSERT INTO PHIEUNHAP (MaPN, MaNV, MaNCC, TongTien, GhiChu) VALUES ('PN01', 'NV005', 'NCC001', 23370000, N'Nhập đủ lô Váy');
INSERT INTO PHIEUNHAP (MaPN, MaNV, MaNCC, TongTien, GhiChu) VALUES ('PN02', 'NV006', 'NCC003', 40550000, N'Nhập lô Áo');
INSERT INTO PHIEUNHAP (MaPN, MaNV, MaNCC, TongTien, GhiChu) VALUES ('PN03', 'NV007', 'NCC012', 17925000, N'Nhập các loại mũ nón');
INSERT INTO PHIEUNHAP (MaPN, MaNV, MaNCC, TongTien, GhiChu) VALUES ('PN04', 'NV008', 'NCC006', 39450000, N'Nhập quần các loại');
INSERT INTO PHIEUNHAP (MaPN, MaNV, MaNCC, TongTien, GhiChu) VALUES ('PN05', 'NV005', 'NCC011', 29550000, N'Nhập túi xách');
INSERT INTO PHIEUNHAP (MaPN, MaNV, MaNCC, TongTien, GhiChu) VALUES ('PN06', 'NV006', 'NCC008', 29990000, N'Nhập giày tây, sneaker');
...
-- =======================================================
-- 6. ĐƠN HÀNG (MÃ TỪ DH01 - DH10, KẾT NỐI KH00000KH01-KH000006, NV009-NV012)
-- =======================================================
INSERT INTO DIACHI (MaDC, MaKH, TenNguoiNhan, SDTNguoiNhan, TinhThanh, PhuongXa, DiaChiChiTiet) VALUES ('DC01', 'KH000003', N'Trịnh Tú Quyên', '0944000001', N'TP. Hồ Chí Minh', N'Linh Trung', N'Số 12 Đường số 5');
INSERT INTO DIACHI (MaDC, MaKH, TenNguoiNhan, SDTNguoiNhan, TinhThanh, PhuongXa, DiaChiChiTiet) VALUES ('DC02', 'KH000004', N'Cao Thanh Tâm', '0944000002', N'TP. Hồ Chí Minh', N'Tăng Nhơn Phú A', N'24/5 Lê Văn Việt');
INSERT INTO DIACHI (MaDC, MaKH, TenNguoiNhan, SDTNguoiNhan, TinhThanh, PhuongXa, DiaChiChiTiet) VALUES ('DC03', 'KH000005', N'Đào Tố Uyên', '0944000003', N'Bình Dương', N'Đông Hòa', N'Khu phố Tân Hòa');
INSERT INTO DIACHI (MaDC, MaKH, TenNguoiNhan, SDTNguoiNhan, TinhThanh, PhuongXa, DiaChiChiTiet) VALUES ('DC04', 'KH000006', N'Châu Tường Vy', '0944000004', N'TP. Hồ Chí Minh', N'Bến Nghé', N'100 Đồng Khởi');
INSERT INTO DIACHI (MaDC, MaKH, TenNguoiNhan, SDTNguoiNhan, TinhThanh, PhuongXa, DiaChiChiTiet) VALUES ('DC05', 'KH000002', N'Nguyễn Thị Thu', '0987654321', N'TP. Hồ Chí Minh', N'Phường 14', N'453 Cách Mạng Tháng 8');

-- Đơn Offline
INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH01', 'KH000002', 'NV009', NULL, 'KM01', 'OFFLINE', N'Đã hoàn thành', 700000, 0, N'Tiền mặt', 70);
...
INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH02', 'KH000001', 'NV010', NULL, NULL, 'OFFLINE', N'Đã hoàn thành', 350000, 0, N'Chuyển khoản Momo', 0);
INSERT INTO CHITIET_DONHANG (MaDH, MaSP, SoLuong, DonGia) VALUES ('DH02', 'SP002', 1 ,350000);

INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH03', 'KH000003', 'NV011', NULL, NULL, 'OFFLINE', N'Đã hoàn thành', 560000, 0, N'Tiền mặt', 56);
...
INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH04', 'KH000001', 'NV012', NULL, NULL, 'OFFLINE', N'Đã hoàn thành', 300000, 0, N'Thẻ ngân hàng', 0);
INSERT INTO CHITIET_DONHANG (MaDH, MaSP, SoLuong, DonGia) VALUES ('DH04', 'SP007', 2, 300000);

INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH05', 'KH000004', 'NV009', NULL, NULL, 'OFFLINE', N'Đã hoàn thành', 1200000, 0, N'Chuyển khoản VNPAY', 120);
INSERT INTO CHITIET_DONHANG (MaDH, MaSP, SoLuong, DonGia) VALUES ('DH05', 'SP035', 1, 1200000);

-- Đơn Online
INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH06', 'KH000003', 'NV010', 'DC01', NULL, 'ONLINE', N'Đang giao', 450000, 30000, N'Ví điện tử ZaloPay', 42);
INSERT INTO CHITIET_DONHANG (MaDH, MaSP, SoLuong, DonGia) VALUES ('DH06', 'SP003', 1,  420000);

INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH07', 'KH000004', 'NV011', 'DC02', NULL, 'ONLINE', N'Đã giao', 600000, 20000, N'COD (Tiền mặt)', 58);
INSERT INTO CHITIET_DONHANG (MaDH, MaSP, SoLuong, DonGia) VALUES ('DH07', 'SP004', 2, 580000);

INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH08', 'KH000005', 'NV012', 'DC03', NULL, 'ONLINE', N'Chờ xác nhận', 530000, 30000, N'Thẻ quốc tế Visa', 50);
...
INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH09', 'KH000006', 'NV009', 'DC04', NULL, 'ONLINE', N'Đã hủy', 380000, 30000, N'Ví điện tử MoMo', 0);
INSERT INTO CHITIET_DONHANG (MaDH, MaSP, SoLuong, DonGia) VALUES ('DH09', 'SP022', 1, 350000);

INSERT INTO DONHANG (MaDH, MaKH, MaNV, MaDC, MaKM, LoaiDon, TrangThai, TongTien, PhiShip, HinhThucThanhToan, DiemThuong) VALUES ('DH10', 'KH000002', 'NV010', 'DC05', 'KM02', 'ONLINE', N'Đang giao', 850000, 0, N'Chuyển khoản ngân hàng', 85);
INSERT INTO CHITIET_DONHANG (MaDH, MaSP, SoLuong, DonGia) VALUES ('DH10', 'SP036', 1,  850000);


-- =======================================================
-- 7. ĐÁNH GIÁ (MÃ TỪ DG01 - DG36, KẾT NỐI KH000002-KH000006)
-- =======================================================
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG01', 'KH000002', 'SP001', 5, N'Váy chất vải mềm, mặc mát, rất ưng ý!');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG02', 'KH000003', 'SP002', 4, N'Form ôm tôn dáng, vải hơi mỏng nhưng mặc đi tiệc rất xinh.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG03', 'KH000004', 'SP003', 5, N'Mặc đi làm lịch sự, chuẩn form công sở.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG04', 'KH000005', 'SP004', 5, N'Lụa xịn mịn, sờ rất mát tay, màu đỏ rượu sang chảnh.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG05', 'KH000006', 'SP005', 4, N'Màu hồng phấn dễ thương, giặt không bị phai màu.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG06', 'KH000002', 'SP006', 5, N'Họa tiết hoa nhí xinh xẻo, mùa hè mặc đi biển cực hợp.');

INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG07', 'KH000003', 'SP007', 5, N'Vải thấm hút mồ hôi tốt, mặc đi tập gym thoải mái.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG08', 'KH000004', 'SP008', 4, N'Màu xanh bụi ngầu, form rộng rãi đúng chuẩn style streetwear.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG09', 'KH000005', 'SP009', 5, N'Lên dáng áo vest rất đẹp, đường may chỉn chu không chỉ thừa.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG10', 'KH000006', 'SP010', 5, N'Áo khoác mỏng nhẹ, bỏ vào cốp xe tiện lợi, cản gió cực tốt.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG11', 'KH000002', 'SP011', 3, N'Chất cotton dày dặn nhưng giặt xong cần phải ủi lại.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG12', 'KH000003', 'SP012', 5, N'Áo sơ mi lụa mặc rất mát, màu trắng tinh khôi dễ phối đồ.');

INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG13', 'KH000004', 'SP013', 5, N'Mũ xinh, đội lên nhìn như tiểu thư, lên hình bao đẹp.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG14', 'KH000005', 'SP014', 4, N'Form cá tính, màu rêu rất tây, chất kaki cứng cáp.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG15', 'KH000006', 'SP015', 5, N'Cói đan chắc chắn, vành rộng che nắng tốt khi đi biển.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG16', 'KH000002', 'SP016', 4, N'Đội vừa vặn, màu trắng basic dễ mix quần áo.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG17', 'KH000003', 'SP017', 5, N'Đội ngầu, mũ cứng cáp không bị móp méo khi giao.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG18', 'KH000004', 'SP018', 5, N'Mũ siêu nhẹ, thoát mồ hôi tốt, rất ưng ý để chạy bộ.');

INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG19', 'KH000005', 'SP019', 4, N'Vải jean co giãn nhẹ, mặc đi làm cả ngày vẫn thoải mái.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG20', 'KH000006', 'SP020', 5, N'Dáng thể thao năng động, túi hộp lớn tiện để điện thoại.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG21', 'KH000002', 'SP021', 5, N'Quần kaki dáng lửng trẻ trung, đường may chắc chắn.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG22', 'KH000003', 'SP022', 3, N'Ống đứng đẹp nhưng ống quần hơi dài so với mình, phải đi cắt gấu.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG23', 'KH000004', 'SP023', 5, N'Dáng baggy che khuyết điểm chân to cực tốt, màu nâu tây tôn da.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG24', 'KH000005', 'SP024', 5, N'Form quần tây chuẩn, là ủi dễ dàng, xếp ly đẹp.');

INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG25', 'KH000006', 'SP025', 5, N'Ví thiết kế sang trọng, cầm vừa tay, chất da mềm mịn.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG26', 'KH000002', 'SP026', 5, N'Túi tote đựng được cả laptop và sách vở, giá quá rẻ.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG27', 'KH000003', 'SP027', 4, N'Màu hồng pastel xinh, dây xích chắc chắn, nhưng chất liệu dễ bám bẩn.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG28', 'KH000004', 'SP028', 5, N'Da thật sờ rất thích, form túi đứng không bị xẹp, khóa kéo xịn.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG29', 'KH000005', 'SP029', 5, N'Mình mua tặng bạn nam, bạn ấy rất thích, ngăn đựng thẻ tiện lợi.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG30', 'KH000006', 'SP030', 4, N'Túi rộng rãi, form công sở thanh lịch, quai xách chắc tay.');

INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG31', 'KH000002', 'SP031', 5, N'Giày da bóng loáng, đi êm chân không bị đau gót, chuẩn size.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG32', 'KH000003', 'SP032', 4, N'Gót cao tôn dáng, chắc chắn, nhưng mũi nhọn đi cả ngày hơi mỏi.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG33', 'KH000004', 'SP033', 5, N'Xinh xỉu, mang phối với váy babydoll cực kỳ hợp, đệm giày êm.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG34', 'KH000005', 'SP034', 5, N'Quai mảnh lên chân nhìn thon gọn, khóa cài mượt mà.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG35', 'KH000006', 'SP035', 5, N'Đế cao su xịn, phối đồ streetwear cực chất, ôm chân.');
INSERT INTO DANHGIA (MaDG, MaKH, MaSP, SoSao, NoiDung) VALUES ('DG36', 'KH000002', 'SP036', 5, N'Trọng lượng siêu nhẹ, đế nhún tốt, chạy bộ rất thoải mái.');
