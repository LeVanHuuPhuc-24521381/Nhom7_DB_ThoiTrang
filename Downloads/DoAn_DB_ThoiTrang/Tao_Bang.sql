...
UPDATE DONHANG SET NgayDat = TO_DATE('18/05/2026 08:30:00', 'DD/MM/YYYY HH24:MI:SS') WHERE MaDH = 'DH06';
UPDATE DONHANG SET NgayDat = TO_DATE('19/05/2026 14:05:20', 'DD/MM/YYYY HH24:MI:SS') WHERE MaDH = 'DH07';
UPDATE DONHANG SET NgayDat = TO_DATE('20/05/2026 09:15:00', 'DD/MM/YYYY HH24:MI:SS') WHERE MaDH = 'DH08';
UPDATE DONHANG SET NgayDat = TO_DATE('21/05/2026 10:20:00', 'DD/MM/YYYY HH24:MI:SS') WHERE MaDH = 'DH09';
UPDATE DONHANG SET NgayDat = TO_DATE('21/05/2026 15:45:30', 'DD/MM/YYYY HH24:MI:SS') WHERE MaDH = 'DH10';
ALTER TABLE KHACHHANG ADD CONSTRAINT chk_email_format_kh
    CHECK (REGEXP_LIKE(Email, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$'));

-- Thêm ràng buộc kiểm tra email trực tiếp cho bảng NHACUNGCAP
ALTER TABLE NHACUNGCAP ADD CONSTRAINT chk_email_format_ncc
    CHECK (REGEXP_LIKE(Email, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$'));
...
UPDATE TAIKHOAN 
SET MatKhau = LOWER(STANDARD_HASH(MatKhau, 'SHA256'))
